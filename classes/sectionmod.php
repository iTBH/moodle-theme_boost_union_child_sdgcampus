...
namespace theme_sdg_boost_union;
...
class sectionmod {
    ...
    public function __construct(\section_info $section, bool $nextsection) {
        ...
        $this->url = new \moodle_url('/course/section.php', ['id' => $section->id]);
    ...
    public function get_formatted_name(): string {
        if ($this->nextsection) {
            return get_string('nextsection', 'theme_sdg_boost_union');
        } else {
            return get_string('prevsection', 'theme_sdg_boost_union');
        }
    }
}
