...
$THEME->name = 'sdg_boost_union';
$THEME->scss = function($theme) {
    return theme_sdg_boost_union_get_main_scss_content($theme);
};
$THEME->parents = ['boost_union','boost'];
$THEME->extrascsscallback = 'theme_sdg_boost_union_get_extra_scss';
$THEME->prescsscallback = 'theme_sdg_boost_union_get_pre_scss';
